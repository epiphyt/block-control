...
final class Viewport {
	 ...
	 */
	public static function get_class_name( $entry ) {
	 ...
	 */
	public static function get_media_query( $entry ) {
	 ...
	 */
	public static function render( $block_content, array $entries ) {
	 ...
	 */
	public static function set_custom( array $viewports ) {
	 ...
	 */
	private static function get_breakpoint_in_pixels( $value ) {
		if ( ! \is_string( $value ) ) {
			return null;
		}
	 ...
	 */
	private static function get_preset_media_queries( $viewport ) {
	 ...
	 */
	private static function sanitize( $viewports ) {
	 ...
	 */
	private static function sanitize_breakpoints( $viewport ) {
